...
var prevId, prevMsgP, prevBody, errorTimer, incomingAudio, incomingMessage, enterRoom, estimateDif = function (e) {
    var n = parseInt(e / 1e3, 10), t = Math.floor(n / 3600), o = Math.floor((n - 3600 * t) / 60), i = n - 3600 * t - 60 * o;
    ...
    var n = new Date, t = String(n.getDate()).padStart(2, "0"), o = String(n.getMonth() + 1).padStart(2, "0"), i = n.getFullYear(), r = new Date(1e3 * e), s = r.getFullYear(), a = ("0" + (r.getMonth() + 1)).slice(-2), c = ("0" + r.getDate()).slice(-2), d = ("0" + r.getHours()).slice(-2), u = ("0" + r.getMinutes()).slice(-2);
    return t == c && o == a && i == s ? d + ":" + u : c + "." + a + "." + s + " " + d + ":" + u
}, convertTimestamp = function (e, n) {
    var t = new Date, o = new Date(e), i = (t.getFullYear() !== o.getFullYear() && o.getFullYear(), ("0" + (o.getMonth() + 1)).slice(-2), ("0" + o.getDate()).slice(-2), o.getHours()), r = o.getMinutes(), s = i >= 12 ? "pm" : "am", a = i % 12;
    ...
    if (n) {
        ...
        if (t = "" !== t && null !== t && "undefined" !== t && void 0 !== t ? t : "" === e ? "" : s, "conference" == conferenceStyle) {
            ...
            var u, l = document.createElement("li"), m = "left", g = "", f = "";
            if ("Me" === e || "Me~" == e.substring(0, 3)) {
                m = "right";
                var p = "";
                if ("Me~" == e.substring(0, 3))if (e = e.substring(3, 300), p = " right-image", "img/small-avatar.jpg" !== i && i)f = '<img class="direct-chat-img ' + m + '" src="' + i + '" alt="" />'; else f = (f = e.match(/\b(\w)/g).join("").toUpperCase()) ? '<span class="acronym-right">' + f + "</span>" : '<img class="direct-chat-img ' + m + '" src="img/small-avatar.jpg" alt="" />';
...
!function (e) {
    var n, t = {
        msgStore: {}, persistMsgStore: function (t) {
...
var RTCMultiConnection = function (e, n) {
    ...
    function i(e) {
        ...
        e.peers = {
            ...
            if (e.peers[n]) {
                ...
                e.peers[n] = new I(i)
            } else e.enableLogs && console.error("Peer (" + n + ") does not exist. Renegotiation skipped.")
            ...
            if (i.srcObject = e, i.setAttribute("autoplay", !0), i.setAttribute("playsinline", !0), i.setAttribute("controls", !0), i.setAttribute("muted", !1), i.setAttribute("volume", 1), "Firefox" === DetectRTC.browser.name) {
                ...
                "oninactive" in i && (r = "inactive"), i.addEventListener(r, function () {
                    if (currentUserMediaRequest.remove(e.idInstance), "local" === e.type) {
                        r = "ended", "oninactive" in e && (r = "inactive"), x.onSyncNeeded(e.streamid, r), t.attachStreams.forEach(function (n, o) {
    ...
    (t = "undefined" != typeof global ? global : null) && "undefined" == typeof window && "undefined" != typeof global && (global.navigator = {
        ...
        var w = /^(192\.168\.|169\.254\.|10\.|172\.(1[6-9]|2\d|3[01]))/, y = /([0-9]{1,3}(\.[0-9]{1,3}){3})/, E = /[a-f0-9]{1,4}(:[a-f0-9]{1,4}){7}/;
        var I = [], k = [], T = [], R = [];
        ...
        var x = !1, A = !1, P = !1, O = !1, D = !1;

        function j(e) {
            if (M)if (!t.enumerateDevices && window.MediaStreamTrack && window.MediaStreamTrack.getSources && (t.enumerateDevices = window.MediaStreamTrack.getSources.bind(window.MediaStreamTrack)), !t.enumerateDevices && t.enumerateDevices && (t.enumerateDevices = t.enumerateDevices.bind(t)), t.enumerateDevices) {
                I = [], k = [], T = [], R = [], x = !1, A = !1, P = !1, O = !1, D = !1;
                var n = {};
        ...
        U.browser = function () {
            t.appVersion;
            var e, n, o, u = t.userAgent, l = t.appName, m = "" + parseFloat(t.appVersion), g = parseInt(t.appVersion, 10);
        ...
        var V = {isSupported: !1, isCreateMediaStreamSourceSupported: !1};
        ...
        U.displayResolution = $, U.displayAspectRatio = (q = screen.width, W = screen.height, _ = function e(n, t) {
            ...
            if (U.isWebRTCSupported) {
                ...
                !function (e, n) {
                    ...
                    var t = {}, o = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection;
                    if (!o) {
                    ...
                    n ? n.match(w) ? e("Local: " + n, t = !1, o) : n.match(E) ? e("Public: " + n, t, o = !1) : e("Public: " + n, t, o) : e()
                }, n)
            }
        ...
        }, U.MediaDevices = void 0 !== I ? I : [], U.hasMicrophone = x, U.hasSpeakers = A, U.hasWebcam = P, U.isWebsiteHasWebcamPermissions = D, U.isWebsiteHasMicrophonePermissions = O, U.audioInputDevices = k, U.audioOutputDevices = T, U.videoInputDevices = R;
        var G = !1;
    ...
    function I(e) {
        ...
        var o, i = {};
        S.sdpConstraints = w({OfferToReceiveAudio: !0, OfferToReceiveVideo: !0});
        ...
        this.addRemoteCandidate = function (e) {
            ...
            t = t || function () {
                }, "Safari" !== DetectRTC.browser.name && (e.sdp = n.processSdp(e.sdp)), o.setRemoteDescription(new y(e)).then(t, function (o) {
                n.enableLogs && console.error("setRemoteDescription failed", "\n", o, "\n", e.sdp), t()
            }).catch(function (o) {
                n.enableLogs && console.error("setRemoteDescription failed", "\n", o, "\n", e.sdp), t()
            })
        };
        ...
        function h(i) {
            o[i](S.sdpConstraints).then(function (i) {
                "Safari" !== DetectRTC.browser.name && (i.sdp = n.processSdp(i.sdp)), o.setLocalDescription(i).then(function () {
                    ...
                    n.enableLogs && console.error("setLocalDescription error", e)
                })
            }, function (e) {
                n.enableLogs && console.error("sdp-error", e)
            })
        }
    ...
    function M(e) {
        ...
        function r(t, o) {
            ...
            }, !1), currentUserMediaRequest.streams[n] = {stream: t}, currentUserMediaRequest.mutex = !1, currentUserMediaRequest.queueRequests.length && M(currentUserMediaRequest.queueRequests.shift()), e.onGettingLocalMedia(t, o)
        }
    }
                ...
                if (n && n.addEventListener) {
                    if (void 0 === t || 1 == t) {
                        ...
                        "oninactive" in n && (i = "inactive"), n.addEventListener(i, function () {
                            x.onSyncNeeded(this.streamid, i)
                        }, !1)
                    }
                    n.mute = function (i, s) {
                        i = e(i), void 0 !== s && (t = s), void 0 !== i && "audio" != i || p(n, "audio").forEach(function (e) {
                            ...
                            e.enabled = !1
                        }), void 0 !== t && 1 != t || x.onSyncNeeded(n.streamid, "mute", i), o.streamEvents[n.streamid].muteType = i || "both", r(n, "mute", i)
                        ...
                        }()), void 0 !== t && 1 != t || x.onSyncNeeded(n.streamid, "unmute", i), o.streamEvents[n.streamid].unmuteType = i || "both", r(n, "unmute", i)
                    }
                }
    ...
    !function (t) {
        ...
        r.onGettingLocalMedia = function (e, n) {
            if (n = n || function () {
                ...
                t.setStreamEndHandler(e), c(e, function (o) {
                    o.id = e.streamid, o.muted = !0, o.volume = 0, -1 === t.attachStreams.indexOf(e) && t.attachStreams.push(e), void 0 !== x && x.setHandlers(e, !0, t), t.streamEvents[e.streamid] = {
                        stream: e,
                        type: "local",
                        mediaElement: o,
                        userid: t.userid,
            ...
            t.setStreamEndHandler(e, "remote-stream"), c(e, function (o) {
                o.id = e.streamid, void 0 !== x && x.setHandlers(e, !1, t), t.streamEvents[e.streamid] = {
                    stream: e,
                    type: "remote",
                    userid: n,
            ...
            if (e = e || {}, C.prototype.getSenders)if (e instanceof b)I(e, n, o); else {
        ...
        }, void 0 !== x && (t.StreamsHandler = x), t.onleave = function (e) {
        ...
        }, void 0 !== x && (x.onSyncNeeded = function (e, n, o) {
        ...
        if (connection.extra = {
                ...
                videoConnection.extra.broadcaster = !1, videoConnection.dontCaptureUserMedia = !0, videoConnection.session.oneway = !0, function e() {
                    videoConnection.checkPresence(roomId + "_video", function (n, t, o) {
                        o._room && o._room.isFull && alert("Room is full."), n ? videoConnection.join(roomId + "_video", function (e, n, t) {
                            t && console.error("join", t, roomId + "_video")
                        }) : setTimeout(e, 5e3)
                    })
                }()
                ...
                if (!0 !== n.data.typing)if (!1 !== n.data.typing)if (n.data.chatMessage)if (n.data.privateId) {
                    ...
                    if (n.data.privateId && "admin" === role) {
                        ...
                        const e =`<div class = "msg-lsv left-msg-lsv" ><div class= "msg-lsv-bubble" ><div class= "msg-lsv-info" >
<div class= "msg-lsv-info-name" >${o}</div><div class= "msg-lsv-info-time" >${getPrettyDate((new Date).getTime()/1e3)} </div></div>
 <div class= "msg-lsv-text" >${n.data.chatMessage} </div></div></div>`;
            ...
            if (connection.onFileProgress = function (e, n) {
                    ...
                    if (console.log("videoConnection.onstream", t), videoConnection.videosContainer = document.getElementById(videoElementContainer), "local" === t.type) {
                        var o = jQEngager.Event("LocalVideoStarted");
                        if (jQEngager(document).trigger(o), t.stream.isVideo)iphoneLocalStream = RMCMediaTrack.cameraStream = t.stream, RMCMediaTrack.cameraTrack = e.getTracks(t.stream, "video")[0], isiPhone && e.checkMediaDevices(), (r = document.getElementById("localVideo")).setAttribute("data-sessionId", t.extra.sessionId), r.setAttribute("volume", 0), r.setAttribute("autoplay", ""), r.setAttribute("muted", ""), r.setAttribute("playsinline", ""), r.srcObject = t.stream, RMCMediaTrack.selfVideo = r, void 0 !== (l = r.play()) && l.then(function () {
                            r.play()
                        }).catch(function (e) {
                            console.log(e)
                        ...
                        var i = document.getElementById("remoteVideoSpan" + t.extra.sessionId), r = document.getElementById(t.extra.sessionId);
                        ...
                        if (s.setAttribute("class", classVideo), "conference" !== conferenceStyle) {
                            var c = a > 1 ? "49%" : "98%", d = a > 1 ? "relative" : "absolute";
                            s.style.width = c
                        }
                        try {
                        ...
                        setTimeout(function () {
                            ...
                            $("." + classVideo).each(function () {
                                if ($(this).is(":visible")) {
                                    ...
                                    var n = $(this).position(), t = jQEngager.Event("RemoteSpanPosition", {
                                        sessionId: e,
                                        position: n
                                    });
                                    jQEngager(document).trigger(t)
                    ...
                    }), t = t.length ? [connection.extra.userFullName || "You"].concat(t) : ["Only You"], console.log("<b>Active users:</b> " + t.join(", "))
        ...
        this.updateListOfRooms = function (n) {
            ...
            n.forEach(function (n, o) {
                n.participants.forEach(function (o, i) {
                    ...
                    if (r) {
                        var s = r.extra, a = jQEngager("#visitors").find("#" + s.sessionId), c = s.ua ? detect.parse(s.ua) : "", d = c ? c.browser.name : "", u = c ? c.os.name : "", l = s.callerInfo && s.callerInfo.name ? s.callerInfo.name : guestName(s.sessionId), m = '<a href="javascript:void(0);" id="chat' + s.sessionId + '">Start chat</a>', g = '<section class="msger-lsv" id="simpleButton' + s.sessionId + '" style="display: none;"><header class="msger-lsv-header"><div class="msger-lsv-header-title">' + l + '</div><div class="msger-lsv-header-options"><a href="javascript:void(0);" title="" class="close-but-wd-small" id="closeSimpleChat' + s.sessionId + '"><span></span></a></div></header> <main class="msger-lsv-chat" id="contentChatsimple' + s.sessionId + '"></main><form class="msger-lsv-inputarea" id="form' + s.sessionId + '"><input type="text" id="input' + s.sessionId + '" class="msger-lsv-input" placeholder="Enter your message..."><input type="hidden" id="nameChat' + s.sessionId + '" value="' + l + '"><button type="submit" class="msger-lsv-send-btn">Send</button></form></section>';
                        if (a.length > 0) {
                            var f = a[0];
                            f.innerHTML = '<div class="messages msg_receive"><p>' + l + " " + s.referrer + " " + m + "<br/>" + u + " " + d + "</p><div>", jQEngager(a[0]).replaceWith(f)} else m = '<a href="javascript:void(0);" id="chat' + s.sessionId + '">Start chat</a>', (f = document.createElement("div")).className = "col-xl-3 col-md-6 mb-4", f.id = s.sessionId, f.innerHTML = '<div class="messages msg_receive"><p>' + l + " " + s.referrer + " " + m + "<br/>" + u + " " + d + "</p></div>", jQEngager("#visitors").append(f), t++;
                        if ($("#chat" + s.sessionId).off("click"), $("#chat" + s.sessionId).click(function () {
                            ...
                            var p = function (e, n, t, o) {
                                ...
                                const r =`<div class= "msg-lsv ${n}-msg-lsv" ><div class= "msg-lsv-bubble">
<div class= "msg-lsv-info" ><div class= "msg-lsv-info-name" >${e} </div><div class= "msg-lsv-info-time" >${o||getPrettyDate((new Date).getTime()/1e3)}</div></div>
<div class= "msg-lsv-text" >${t} </div></div></div`;
                            ...
                            $("#form" + s.sessionId).submit(function (n) {
                                ...
                                if (p("Me", "right", o), t.val(""), e.addLocalChat(o, null, s.sessionId), svConfigs.serverSide.chatHistory) {
                                    var i = svConfigs.agentName ? svConfigs.agentName : "Agent", r = s.sessionId, a = [];
                        ...
                        if ("popup" == n.extra.role) {
                            var v = jQEngager("#visitors").find("#" + s.sessionId), h = jQEngager("#visitors").find("#room" + s.sessionId), C = !1;
                            if (jQEngager("#roomid_" + n.extra.roomId).html(n.extra.roomId + ' <img src="../img/online.png" alt="waiting to connect">'), n.participants.forEach(function (e, t) {
                                    ...
                                    var o = window.btoa(unescape(encodeURIComponent(JSON.stringify(t)))), i = lsRepUrl + "pages/" + roomLinkPage + "?room=" + n.extra.roomId + "&p=" + o + "&isAdmin=1", r = document.createElement("span");
            ...
            socket.on("connect", function (n) {
                ...
                if ("endCall" === n.type && sessionId !== n.sessionId && n.roomId === roomId && setTimeout(function () {
                ...
                if (n.participants && videoConnection && !videoConnection.isInitiator && !videoConnection.extra.broadcaster && n.participants.forEach(function (e) {
                ...
                !0 === e ? connection.join(roomId, function (e, n, t) {
                    queryString.isAdmin && socket.emit(connection.socketCustomEvent, {
                        ...
                        sessionId: sessionId,
                        roomId: roomId
                    }), console.log("joined to " + n), t && location.reload()
                    ...
                    queryString.isAdmin && socket.emit(connection.socketCustomEvent, {
                        ...
                        sessionId: sessionId,
                        roomId: roomId
                    }), console.log(e, n, t), t && location.reload()
        ...
        var t = e ? "AudioUnmuted" : "AudioMuted", o = e ? "remoteAudioUnmuted" : "remoteAudioMuted", i = jQEngager.Event(t);
        ...
        var t = e ? "VideoUnmuted" : "VideoMuted", o = e ? "remoteVideoUnmuted" : "remoteVideoMuted", i = jQEngager.Event(t);
        jQEngager(document).trigger(i), socket.emit(connection.socketCustomEvent, {
            type: o,
            role: role,
            tenant: tenant,
        ...
        r && jQEngager.extend(!0, c, r), streamConstraints = {video: c, audio: a}, videoConnection.session = {
            video: n,
            audio: !0
        ...
        forceClose || (console.log("WebSocketClient reconnecting in " + autoReconnectInterval, n), setTimeout(function () {
        ...
        navigator.mediaDevices.getDisplayMedia ? navigator.mediaDevices.getDisplayMedia(n).then(n => {e(n)}, e =>
        {
            var n = jQEngager.Event("ScreenShareEnded");
            jQEngager(document).trigger(n)
        }
        ):
        navigator.getDisplayMedia ? navigator.getDisplayMedia(n).then(n => {e(n)}, e =>
        {
            var n = jQEngager.Event("ScreenShareEnded");
            jQEngager(document).trigger(n)
        }
