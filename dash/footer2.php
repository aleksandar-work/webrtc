...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; LearnBoard <?php echo date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<div class="modal fade" id="generateBroadcastLinkModal" tabindex="-1" role="dialog"
     aria-labelledby="generateBroadcastLinkModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">Broadcaster URL is opened in a new tab and visitor URL is stored in your clipboard,
                so you can send to your attendees. <br/> You can copy it from here: <br/> [generateBroadcastLink]
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="generateLinkModal" tabindex="-1" role="dialog" aria-labelledby="generateLinkModal"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">Agent URL is opened in a new tab and visitor URL is stored in your clipboard, so you
                can send to your attendees. <br/> You can copy it from here: <br/> [generateLink]
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Close</button>
            </div>
...
console.log(result);
                        ...
                        $.each(result, function (i, item) {
                            ...
                            html += '<div class="col-xl-3 col-md-6 mb-4">' +
                                ...
                                '<div class="col mr-2">' +
                                '<div class="text-xs font-weight-bold text-success text-uppercase mb-1">'+item.roomId+'</div>' +
                                '</div>' +
                                '<div class="col-auto">' +
                                ...
                                '<div class="row no-gutters align-items-center">' +
                                '<div class="col mr-1">' +
                                '<div class="text-xl-center font-weight-bold text-dark text-uppercase mb-1"><a target="_blank" title="Conference visitor URL" href="' + item.agenturl_broadcast + '">'+item.agent+'</a></div>' +
                                '</div>' +
                                '</div>' +
                                '<div style="float: right">by '+ item.agent_id +'</div>' +
                                '</div>' +
                                '</div>' +
                                '</div>';

                        });
                        $('#classroom_entry').html(html);
...
<script src="../js/loader.v2.js" data-source_path="<?php echo $actual_link; ?>"></script>
</body>
