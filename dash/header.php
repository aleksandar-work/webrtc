...
<html lang="en">
    ...
    <head>
        ...
        <title>DanDash Agent Dashboard</title>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseAgents" class="collapse" aria-labelledby="collapseAgents" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="agents.php">List Doctors</a>
                                <a class="collapse-item" href="agent.php">Add New Doctor</a>
                            </div>
                        </div>
                    </li>
                <?php } ?>
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseUsers" class="collapse" aria-labelledby="collapseUsers" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                ...
                                <a class="collapse-item" href="users.php">List Clients</a>
                                <a class="collapse-item" href="user.php">Add New Client</a>
                            </div>
                        </div>
                    </li>
                <?php } ?>
